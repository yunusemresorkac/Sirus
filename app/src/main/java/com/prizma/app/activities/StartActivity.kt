...
import com.prizma.app.databinding.ActivityStartBinding
import com.prizma.app.model.User
import com.prizma.app.model.WeeklyReward
...
class StartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareApp.setOnClickListener {
            val shareText ="Ödüllü bilgi yarışması Prizma'ya sen de gel ve kazanmaya başla. Birbirinden keyifli sorular burada! \n https://play.google.com/store/apps/details?id=${packageName}"
    ...
    private fun showBuyDialog(){
        ...
        buyOneTicket.setOnClickListener {
            startActivity(Intent(this, com.prizma.app.activities.BuyTicketActivity::class.java)
