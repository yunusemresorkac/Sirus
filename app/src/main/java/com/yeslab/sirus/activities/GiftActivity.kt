...
import com.yeslab.sirus.adapter.GiftAdapter
import com.yeslab.sirus.controller.DummyMethods
import com.yeslab.sirus.databinding.ActivityGiftBinding
...
class GiftActivity : AppCompatActivity(),GiftClick {
    ...
    private fun addOrder(gift: Gift){
        ...
        val order = Order(firebaseUser.uid,id,gift.title,gift.price,Constants.PENDING_ORDER,"", gift.id,gift.imageUrl)
